...
class FormValidation {
  ...
  _validationMessage() {
      jQuery.extend(jQuery.validator.messages, {
          ...
          equalTo: "Harap masukkan nilai yang sama kembali.",
          ...
          rangelength: jQuery.validator.format(
              "Harap masukkan nilai antara {0} dan {1} karakter."
          ),
          range: jQuery.validator.format(
              "Harap masukkan nilai antara {0} dan {1}."
          ),
          max: jQuery.validator.format(
              "Harap masukkan nilai kurang dari atau sama dengan {0}."
          ),
          min: jQuery.validator.format(
              "Harap masukkan nilai lebih besar dari atau sama dengan {0}."
          ),
      });
  }
