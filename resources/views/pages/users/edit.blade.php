@php
    ...
    $title = 'Edit Data';
    $description = 'Halaman Edit Data Pengguna';
    $breadcrumbs = [route('dashboard.index') => 'Beranda', route('users.index') => 'Daftar Data Pengguna',  route('dokumen-keluar.index') . '/' . $users->id => 'Edit Data'];
@endphp
