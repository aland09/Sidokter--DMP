                                        ...
                                        data-bs-target="#collapse{{ $item->id }}">
                                            ...
                                            <td style="height: 42px !important" class="py-2">
                                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                    ...
                                                    <button
                                                        class="btn btn-icon btn-icon-only btn-sm btn-primary modal-verifikasi"
                                            ...
                                            <td class="border" colspan="20">
                                                <div class="data-table-responsive-wrapper overflow-auto">
                                                    <table class="data-table dataTable no-footer">
                                                        <tr>
                                                            <td class="bg-primary text-white text-small text-uppercase">No.</td>
                                                            <td class="bg-primary text-white text-small text-uppercase">Kode
                                                                Klasifikasi</td>
                                                            <td class="bg-primary text-white text-small text-uppercase">Uraian</td>
                                                            <td class="bg-primary text-white text-small text-uppercase">Tanggal Surat
                                                            </td>
                                                            <td class="bg-primary text-white text-small text-uppercase">Jumlah Satuan
                                                            </td>
                                                            <td class="bg-primary text-white text-small text-uppercase">Keterangan
                                                            </td>
                                                            <td class="bg-primary text-white text-small text-uppercase">Jenis Naskah
                                                                Dinas</td>
                                                            <td style="widtd: 300px !important"
                                                                class="bg-primary text-white text-small text-uppercase">
                                                                No. Surat</td>
                                                            <td class="bg-primary text-white text-small text-uppercase">Pejabat
                                                                Penandatangan</td>
                                                            <td class="bg-primary text-white text-small text-uppercase">Unit Pengolah
                                                            </td>
                                                            <td class="bg-primary text-white text-small text-uppercase">Kurun Waktu
                                                            </td>
                                                            <td class="bg-primary text-white text-small text-uppercase">No. Box</td>
                                                            <td colspan="7"
                                                                class="bg-primary text-white text-small text-uppercase">Tingkat
                                                                Perkembangan</td>
                                                        ...
                                                        @foreach ($item->detailDokumen ?? [] as $subitem)
                                                            <tr class="border">
                                                                ...
                                                                <td style="height: 42px !important" class="empty py-2 border-start border-top border-bottom">
                                                                    {{ $loop->index + 1 }}.</td>
                                                                ...
                                                                <td style="height: 42px !important" class="py-2 border-top border-bottom border-end">
                                                                    <div
